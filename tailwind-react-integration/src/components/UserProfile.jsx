export default function UserProfile() {
  return (
    <div className="bg-gray-100 rounded-lg shadow-lg sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm mx-auto my-20 text-center">
      <img
      ...
      />
      <h2 className="mt-4 my-4 font-bold sm:text-lg md:text-xl text-blue-800 
